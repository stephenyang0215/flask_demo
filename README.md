Development of REST APIs with flask, postgres for warehousing. Serialized messages are sent to the server and get deserialized to store in the database. <br />
